trait TemplateMethod {
    fn base_operation1(&self) {
        print!("TemplateMethods say: I am doing the bulk of the work.");
    }

    fn base_operation2(&self) {
        print!("TemplateMethods say: But I let subclass override some operations.");
    }

    fn base_operation3(&self) {
        print!("TemplateMethods say: But I ad doing the bulk of the work anyway.");
    }
